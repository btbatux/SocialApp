...
public class Fragment1 extends Fragment implements View.OnClickListener {
    ImageView imageView;
    TextView nameEt, profEt, bioEt, emailEt, webEt, postTv, followertv, newtv;
    ImageButton imageButtonEdit, imageButtonMenu;
    DocumentReference reference;
    FirebaseFirestore firestore;
    Button btnsendmessage, tv_addstories_f1;
    Uri imageUri;
    String url, userid;
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            if (document.exists()) {
                                // Profil bilgilerini al ve göster
    ...
    private void loadFollowerCount() {
        db1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                followertv.setText(followerno + " Followers");
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(getActivity(), "Failed to load followers", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initViews() {
        ...
        tv_addstories_f1 = getActivity().findViewById(R.id.tv_addstories_f1);
        ...
        applyColorTransitionAnimation(bioEt);
        applyColorTransitionAnimation(emailEt);
        applyColorTransitionAnimation(webEt);
    }
    ...
    private void setupClickListeners() {
        ...
        tv_addstories_f1.setOnClickListener(this);
    ...
    private void applyColorTransitionAnimation(TextView textView) {
        ObjectAnimator colorAnim = ObjectAnimator.ofInt(textView, "textColor", Color.RED, Color.BLUE);
        colorAnim.setDuration(2000); // 1 saniye süresinde
